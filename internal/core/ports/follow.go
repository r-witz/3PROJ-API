...
type FollowRepository interface {
	...
	GetFollowersPaginated(ctx context.Context, userID uuid.UUID, offset, limit int) ([]*domain.Follow, int, error)
	GetFollowingPaginated(ctx context.Context, userID uuid.UUID, offset, limit int) ([]*domain.Follow, int, error)
