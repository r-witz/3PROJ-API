...
type ActivityService interface {
	GetByUserID(ctx context.Context, userID uuid.UUID, offset, limit int) ([]*ActivityFeedItem, int, error)
	GetFeedForUser(ctx context.Context, userID uuid.UUID, offset, limit int) ([]*ActivityFeedItem, int, error)
