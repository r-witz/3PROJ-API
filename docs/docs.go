        ...
        "/collections/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Cannot delete system collection",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Cannot modify system collection",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/collections/{id}/items/{tmdbId}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid collection or TMDB ID",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
